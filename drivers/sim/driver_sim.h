...
{
    sim_adc_trigger_source_t SIM_ADC_Trigger_source;
    sim_adc_pretrigger_source_t SIM_ADC_PreTrigger_source;
} sim_adc0_opt_t;
...
{
    SIM->ADCOPT |= SIM_ADCOPT_ADC0TRGSEL(option->SIM_ADC_Trigger_source) |
                   SIM_ADCOPT_ADC0PRETRGSEL(option->SIM_ADC_PreTrigger_source);
}
